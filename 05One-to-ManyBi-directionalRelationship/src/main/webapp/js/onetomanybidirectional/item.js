...
function create(){
	...
	$.ajax({url : "/onetomanybidirectional/create",type: "POST",
...
function loadObjects(){
	$.ajax({
		url : "/onetomanybidirectional/findAll",type: "GET",data : {},dataType: "json",
...
function deleteObject(itemid){
	...
	delurl="/onetomanybidirectional/remove/"+itemid;
...
function update(){
	...
	$.ajax({
		url : "/onetomanybidirectional/edit",
		type: "POST",
...
function editObject(itemid){
	editurl="/onetomanybidirectional/findById/"+itemid;
	var itemForm={id:itemid};
