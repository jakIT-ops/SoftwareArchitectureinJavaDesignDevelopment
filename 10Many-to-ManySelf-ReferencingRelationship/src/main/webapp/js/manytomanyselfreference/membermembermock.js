...
function isPresent(){
	...
	if(null != memberid1 && "" != memberid1 && null!= memberid2 && "" != memberid2) {
		...
		$.ajax({
			url : "/manytomanyselfreference/membermember/mock/isPresent",
			type: "POST",
...
function createMemberMember(memberid1, memberid2, membername1, membername2){
	...
	if(memberid1 != memberid2) {
		$.ajax({
			url : "/manytomanyselfreference/membermember/mock/create",
			type: "POST",
			data : JSON.stringify(formData),
			beforeSend: function(xhr) {
				xhr.setRequestHeader("Accept", "application/json");
...
function createMember(){
	...
	if(null != name && "" != name) {
		...
		$.ajax({
			url : "/manytomanyselfreference/member/mock/create",
			type: "POST",
			data : JSON.stringify(formData),
			beforeSend: function(xhr) {
				xhr.setRequestHeader("Accept", "application/json");
...
function updateMember(){
	...
	$.ajax({
		url : "/manytomanyselfreference/member/mock/edit",
		type: "POST",
		data : JSON.stringify(formData),
		beforeSend: function(xhr) {
			xhr.setRequestHeader("Accept", "application/json");
...
function loadObjects(){
	$.ajax({
		url : "/manytomanyselfreference/member/mock/findAll",
		type: "GET",
		data : {},
		dataType: "json",
		success: function(data, textStatus, jqXHR)
	...
	$.ajax({
		url : "/manytomanyselfreference/membermember/mock/findAll",
		type: "GET",
		data : {},
		dataType: "json",
		success: function(data, textStatus, jqXHR)
...
function deleteMemberObject(memberid){
	...
	delurl="/manytomanyselfreference/member/mock/remove/"+memberid;
	$.ajax({
		url : delurl,
		type: "POST",
		data : memberForm,
...
function deleteMemberMemberObject(memberid1,memberid2){
	var formData={"memberId1":{"id":memberid1},"memberId2":{"id":memberid2}};
	delurl="/manytomanyselfreference/membermember/mock/remove";
	$.ajax({
		url : delurl,
		type: "POST",
		data : JSON.stringify(formData),
...
function editMemberObject(memberid){
	editurl="/manytomanyselfreference/member/mock/findById/"+memberid;
	var memberForm={id:memberid};
	$.ajax({
		url : editurl,
		type: "GET",
