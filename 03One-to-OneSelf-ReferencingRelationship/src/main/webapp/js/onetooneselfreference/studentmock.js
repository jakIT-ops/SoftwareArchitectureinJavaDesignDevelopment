...
function create(){
	...
	$.ajax({
		url : "/onetooneselfreference/mock/create",
		type: "POST",
...
function update(){
	...
	$.ajax({
		url : "/onetooneselfreference/mock/edit",
		type: "POST",
		data : JSON.stringify(formData),
		beforeSend: function(xhr) {
			xhr.setRequestHeader("Accept", "application/json");
...
function loadObjects(){
	$.ajax({
		url : "/onetooneselfreference/mock/findAll",
		type: "GET",
		data : {},
		dataType: "json",
		success: function(data, textStatus, jqXHR)
...
function deleteObject(stuid){
	...
	delurl="/onetooneselfreference/mock/remove/"+stuid;
	$.ajax({
		url : delurl,
		type: "POST",
		data : studentForm,
...
function editObject(stuid){
	editurl="/onetooneselfreference/mock/findById/"+stuid;
	var studentForm={id:stuid};
	$.ajax({
		url : editurl,
		type: "GET",
