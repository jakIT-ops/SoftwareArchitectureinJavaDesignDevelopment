...
function create(){
	...
	$.ajax({
		url : "/onetooneselfreference/create",
		type: "POST",
...
function update(){
	...
	$.ajax({
		url : "/onetooneselfreference/edit",
		type: "POST",
		data : JSON.stringify(formData),
		beforeSend: function(xhr) {
			xhr.setRequestHeader("Accept", "application/json");
...
function loadObjects(){
	$.ajax({
		url : "/onetooneselfreference/findAll",
		type: "GET",
		data : {},
		dataType: "json",
		success: function(data, textStatus, jqXHR)
...
function deleteObject(stuid){
	...
	delurl="/onetooneselfreference/remove/"+stuid;
	$.ajax({
		url : delurl,
		type: "POST",
		data : productForm,
...
function editObject(stuid){
	editurl="/onetooneselfreference/findById/"+stuid;
	var productForm={id:stuid};
	$.ajax({
		url : editurl,
		type: "GET",
