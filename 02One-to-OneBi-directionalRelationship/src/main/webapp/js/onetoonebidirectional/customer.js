...
function create(){
	...
	$.ajax({
		url : "/onetoonebidirectional/create",
		type: "POST",
...
function update(){
	...
	$.ajax({
		url : "/onetoonebidirectional/edit",
		type: "POST",
		data : JSON.stringify(formData),
		beforeSend: function(xhr) {
			xhr.setRequestHeader("Accept", "application/json");
...
function loadObjects(){
	$.ajax({
		url : "/onetoonebidirectional/findAll",
		type: "GET",
		data : {},
		dataType: "json",
		success: function(data, textStatus, jqXHR)
...
function deleteObject(customerid){
	...
	delurl="/onetoonebidirectional/remove/"+customerid;
	$.ajax({
		url : delurl,
		type: "POST",
		data : productForm,
...
function editObject(customerid){
	editurl="/onetoonebidirectional/findById/"+customerid;
	var productForm={id:customerid};
	$.ajax({
		url : editurl,
		type: "GET",
