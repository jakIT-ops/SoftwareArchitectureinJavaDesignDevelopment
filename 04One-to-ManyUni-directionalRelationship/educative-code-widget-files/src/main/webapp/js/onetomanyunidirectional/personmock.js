...
function create(){
	...
	$.ajax({url : "/onetomanyunidirectional/mock/create",
			type: "POST",data :
...
function loadObjects(){
	$.ajax({
		url : "/onetomanyunidirectional/mock/findAll",
		type: "GET",
		data : {},
		dataType: "json",
		success: function(data, textStatus, jqXHR){
...
function deleteObject(personid){
	...
	delurl="/onetomanyunidirectional/mock/remove/"+personid;
	$.ajax({url : delurl,
		  	type: "POST",
		  	data : personForm,
		  	dataType: "json",
...
function update(){
	...
	$.ajax({
		url : "/onetomanyunidirectional/mock/edit",
		type: "POST",
...
function editObject(personid){
	editurl="/onetomanyunidirectional/mock/findById/"+personid;
	var personForm={id:personid};
	$.ajax({url : editurl,
			type: "GET",
			data : personForm,
