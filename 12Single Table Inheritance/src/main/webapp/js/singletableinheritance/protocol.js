...
function create(){
	...
	$.ajax({
		url : "/singletableinheritance/create",
		type: "POST",
...
function update(){
	...
	$.ajax({
		url : "/singletableinheritance/edit",
		type: "POST",
		data : JSON.stringify(formData),
		beforeSend: function(xhr) {
			xhr.setRequestHeader("Accept", "application/json");
...
function loadObjects(){
	$.ajax({
		url : "/singletableinheritance/findAll",
		type: "GET",
		data : {},
		dataType: "json",
		success: function(data, textStatus, jqXHR)
...
function deleteObject(protocolid){
	...
	var delurl="/singletableinheritance/remove/"+protocolid;
	$.ajax({
		url : delurl,
		type: "POST",
		data : protocolForm,
...
function editObject(protocolid){
	var editurl="/singletableinheritance/findById/"+protocolid;
	var protocolForm={id:protocolid};
	$.ajax({
		url : editurl,
		type: "GET",
