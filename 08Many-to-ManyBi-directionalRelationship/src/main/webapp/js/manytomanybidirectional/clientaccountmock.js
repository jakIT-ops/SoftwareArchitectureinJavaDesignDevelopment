...
function isPresent(){
	...
	var clientname = $("#clientSelectBox").find('option:selected').text();
	var accountnumber = $("#accountSelectBox").find('option:selected').text();
	
	if(null != clientid && "" != clientid && null!= accountid && "" != accountid) {
		var formData={"clientDto":{"id":clientid},"accountDto":{"id":accountid}};
		$.ajax({
			url : "/manytomanybidirectional/clientaccount/mock/isPresent",
			type: "POST",
			...
			{
				if(!data) {
					createClientAccount(clientid, accountid, clientname, accountnumber);
				} else {
...
function createClientAccount(clientid, accountid, clientname, accountnumber){
	var formData={"clientDto":{"id":clientid, "name":clientname},"accountDto":{"id":accountid, "number":accountnumber}};
	$.ajax({
		url : "/manytomanybidirectional/clientaccount/mock/create",
		type: "POST",
		data : JSON.stringify(formData),
		beforeSend: function(xhr) {
			xhr.setRequestHeader("Accept", "application/json");
...
function createClient(){
	...
	if(null != name && "" != name) {
		...
		$.ajax({
			url : "/manytomanybidirectional/client/mock/create",
			type: "POST",
			data : JSON.stringify(formData),
			beforeSend: function(xhr) {
				xhr.setRequestHeader("Accept", "application/json");
...
function createAccount(){
	...
	if(null != number && "" != number) {
		...
		$.ajax({
			url : "/manytomanybidirectional/account/mock/create",
			type: "POST",
			data : JSON.stringify(formData),
			beforeSend: function(xhr) {
				xhr.setRequestHeader("Accept", "application/json");
...
function updateClient(){
	...
	$.ajax({
		url : "/manytomanybidirectional/client/mock/edit",
		type: "POST",
		data : JSON.stringify(formData),
		beforeSend: function(xhr) {
			xhr.setRequestHeader("Accept", "application/json");
...
function updateAccount(){
	...
	$.ajax({
		url : "/manytomanybidirectional/account/mock/edit",
		type: "POST",
		data : JSON.stringify(formData),
		beforeSend: function(xhr) {
			xhr.setRequestHeader("Accept", "application/json");
...
function loadObjects(){
	$.ajax({
		url : "/manytomanybidirectional/client/mock/findAll",
		type: "GET",
		data : {},
		dataType: "json",
		success: function(data, textStatus, jqXHR)
	...
	$.ajax({
		url : "/manytomanybidirectional/account/mock/findAll",
		type: "GET",
		data : {},
		dataType: "json",
		success: function(data, textStatus, jqXHR)
	...
	$.ajax({
		url : "/manytomanybidirectional/clientaccount/mock/findAll",
		type: "GET",
		data : {},
		dataType: "json",
		success: function(data, textStatus, jqXHR)
...
function deleteClientObject(clientid){
	...
	delurl="/manytomanybidirectional/client/mock/remove/"+clientid;
	$.ajax({
		url : delurl,
		type: "POST",
		data : clientForm,
...
function deleteAccountObject(accountid){
	...
	delurl="/manytomanybidirectional/account/mock/remove/"+accountid;
	$.ajax({
		url : delurl,
		type: "POST",
		data : accountForm,
...
function deleteClientAccountObject(clientid,accountid){
	var formData={"clientDto":{"id":clientid},"accountDto":{"id":accountid}};
	delurl="/manytomanybidirectional/clientaccount/mock/remove";
	$.ajax({
		url : delurl,
		type: "POST",
		data : JSON.stringify(formData),
...
function editClientObject(clientid){
	editurl="/manytomanybidirectional/client/mock/findById/"+clientid;
	var clientForm={id:clientid};
	$.ajax({
		url : editurl,
		type: "GET",
...
function editAccountObject(accountid){
	editurl="/manytomanybidirectional/account/mock/findById/"+accountid;
	var accountForm={id:accountid};
	$.ajax({
		url : editurl,
		type: "GET",
