...
function isPresent(){
	...
	if(null != clientid && "" != clientid && null!= accountid && "" != accountid) {
		...
		$.ajax({
			url : "/manytomanybidirectional/clientaccount/isPresent",
			type: "POST",
...
function createClientAccount(clientid,accountid){
	var formData={"clientDto":{"id":clientid},"accountDto":{"id":accountid}};
	$.ajax({
		url : "/manytomanybidirectional/clientaccount/create",
		type: "POST",
		data : JSON.stringify(formData),
		beforeSend: function(xhr) {
			xhr.setRequestHeader("Accept", "application/json");
...
function createClient(){
	...
	if(null != name && "" != name) {
		...
		$.ajax({
			url : "/manytomanybidirectional/client/create",
			type: "POST",
			data : JSON.stringify(formData),
			beforeSend: function(xhr) {
				xhr.setRequestHeader("Accept", "application/json");
...
function createAccount(){
	...
	if(null != number && "" != number) {
		...
		$.ajax({
			url : "/manytomanybidirectional/account/create",
			type: "POST",
			data : JSON.stringify(formData),
			beforeSend: function(xhr) {
				xhr.setRequestHeader("Accept", "application/json");
...
function updateClient(){
	...
	$.ajax({
		url : "/manytomanybidirectional/client/edit",
		type: "POST",
		data : JSON.stringify(formData),
		beforeSend: function(xhr) {
			xhr.setRequestHeader("Accept", "application/json");
...
function updateAccount(){
	...
	$.ajax({
		url : "/manytomanybidirectional/account/edit",
		type: "POST",
		data : JSON.stringify(formData),
		beforeSend: function(xhr) {
			xhr.setRequestHeader("Accept", "application/json");
...
function loadObjects(){
	$.ajax({
		url : "/manytomanybidirectional/client/findAll",
		type: "GET",
		data : {},
		dataType: "json",
		success: function(data, textStatus, jqXHR)
	...
	$.ajax({
		url : "/manytomanybidirectional/account/findAll",
		type: "GET",
		data : {},
		dataType: "json",
		success: function(data, textStatus, jqXHR)
	...
	$.ajax({
		url : "/manytomanybidirectional/clientaccount/findAll",
		type: "GET",
		data : {},
		dataType: "json",
		success: function(data, textStatus, jqXHR)
...
function deleteClientObject(clientid){
	...
	delurl="/manytomanybidirectional/client/remove/"+clientid;
	$.ajax({
		url : delurl,
		type: "POST",
		data : clientForm,
...
function deleteAccountObject(accountid){
	...
	delurl="/manytomanybidirectional/account/remove/"+accountid;
	$.ajax({
		url : delurl,
		type: "POST",
		data : accountForm,
...
function deleteClientAccountObject(clientid,accountid){
	var formData={"clientDto":{"id":clientid},"accountDto":{"id":accountid}};
	delurl="/manytomanybidirectional/clientaccount/remove";
	$.ajax({
		url : delurl,
		type: "POST",
		data : JSON.stringify(formData),
...
function editClientObject(clientid){
	editurl="/manytomanybidirectional/client/findById/"+clientid;
	var clientForm={id:clientid};
	$.ajax({
		url : editurl,
		type: "GET",
...
function editAccountObject(accountid){
	editurl="/manytomanybidirectional/account/findById/"+accountid;
	var accountForm={id:accountid};
	$.ajax({
		url : editurl,
		type: "GET",
