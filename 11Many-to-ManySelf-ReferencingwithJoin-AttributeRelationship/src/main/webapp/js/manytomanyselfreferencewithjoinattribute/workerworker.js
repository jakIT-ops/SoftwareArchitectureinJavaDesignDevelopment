...
function isPresent(){
	...
	if(null != workerid1 && "" != workerid1 && null!= workerid2 && "" != workerid2 && null!= relationshipType && "" != relationshipType) {
		...
		$.ajax({
			url : "/manytomanyselfreferencewithjoinattribute/workerworker/isPresent",
			type: "POST",
...
function createWorkerWorker(workerid1,workerid2,relationshipType){
	...
	if(workerid1 != workerid2) {
		$.ajax({
			url : "/manytomanyselfreferencewithjoinattribute/workerworker/create",
			type: "POST",
			data : JSON.stringify(formData),
			beforeSend: function(xhr) {
				xhr.setRequestHeader("Accept", "application/json");
...
function createWorker(){
	...
	if(null != name && "" != name) {
		...
		$.ajax({
			url : "/manytomanyselfreferencewithjoinattribute/worker/create",
			type: "POST",
			data : JSON.stringify(formData),
			beforeSend: function(xhr) {
				xhr.setRequestHeader("Accept", "application/json");
...
function updateWorker(){
	...
	$.ajax({
		url : "/manytomanyselfreferencewithjoinattribute/worker/edit",
		type: "POST",
		data : JSON.stringify(formData),
		beforeSend: function(xhr) {
			xhr.setRequestHeader("Accept", "application/json");
...
function loadObjects(){
	$.ajax({
		url : "/manytomanyselfreferencewithjoinattribute/worker/findAll",
		type: "GET",
		data : {},
		dataType: "json",
		success: function(data, textStatus, jqXHR)
	...
	$.ajax({
		url : "/manytomanyselfreferencewithjoinattribute/workerworker/findAll",
		type: "GET",
		data : {},
		dataType: "json",
		success: function(data, textStatus, jqXHR)
...
function deleteWorker(workerid){
	...
	delurl="/manytomanyselfreferencewithjoinattribute/worker/remove/"+workerid;
	$.ajax({
		url : delurl,
		type: "POST",
		data : workerForm,
...
function deleteWorkerWorker(workerid1,workerid2){
	var formData={"workerId1":{"id":workerid1},"workerId2":{"id":workerid2}};
	delurl="/manytomanyselfreferencewithjoinattribute/workerworker/remove";
	$.ajax({
		url : delurl,
		type: "POST",
		data : JSON.stringify(formData),
...
function editWorker(workerid){
	editurl="/manytomanyselfreferencewithjoinattribute/worker/findById/"+workerid;
	var workerForm={id:workerid};
	$.ajax({
		url : editurl,
		type: "GET",
