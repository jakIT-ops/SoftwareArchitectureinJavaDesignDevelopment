...
function create(){
	...
	$.ajax({
		url : "/onetomanyselfreference/create",
		type: "POST",
...
function update(){
	...
	$.ajax({
		url : "/onetomanyselfreference/edit",
		type: "POST",
		data : JSON.stringify(formData),
		beforeSend: function(xhr) {
			xhr.setRequestHeader("Accept", "application/json");
...
function deleteObject(Id){
	...
	delurl="/onetomanyselfreference/remove/"+Id;
	$.ajax({
		url : delurl,
		type: "POST",
		data : productForm,
...
function editObject(Id){
	editurl="/onetomanyselfreference/findById/"+Id;
	var itemForm={id:Id};
	$.ajax({
		url : editurl,
		type: "GET",
...
function loadObjects(){
	$.ajax({
		url : "/onetomanyselfreference/findAll",
		type: "GET",
		data : {},
		dataType: "json",
		success: function(data, textStatus, jqXHR)
