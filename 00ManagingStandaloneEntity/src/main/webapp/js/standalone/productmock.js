...
function deleteObject(productid){
	...
	delurl="/standalone/mock/remove/"+productid;
	$.ajax({
		url : delurl,
		type: "POST",
		data : productForm,
...
function editObject(productid){
	editurl="/standalone/mock/findById/"+productid;
	var productForm={id:productid};
	$.ajax({
		url : editurl,
		type: "GET",
