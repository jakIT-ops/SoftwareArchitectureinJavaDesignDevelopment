...
function isPresent(){
	...
	if(null != userid && "" != userid && null!= groupid && "" != groupid) {
		...
		$.ajax({
			url : "/manytomanyunidirectional/usergroup/mock/isPresent",
			type: "POST",
...
function createUserGroup(userid,groupid, username, groupname){
	...
	$.ajax({
		url : "/manytomanyunidirectional/usergroup/mock/create",
		type: "POST",
		data : JSON.stringify(formData),
		beforeSend: function(xhr) {
			xhr.setRequestHeader("Accept", "application/json");
...
function createUser(){
	...
	if(null != name && "" != name) {
		...
		$.ajax({
			url : "/manytomanyunidirectional/user/mock/create",
			type: "POST",
			data : JSON.stringify(formData),
			beforeSend: function(xhr) {
				xhr.setRequestHeader("Accept", "application/json");
...
function createGroup(){
	...
	if(null != name && "" != name) {
		var formData={"name":name};
		$.ajax({
			url : "/manytomanyunidirectional/group/mock/create",
			type: "POST",
			data : JSON.stringify(formData),
			beforeSend: function(xhr) {
				xhr.setRequestHeader("Accept", "application/json");
...
function updateUser(){
	...
	$.ajax({
		url : "/manytomanyunidirectional/user/mock/edit",
		type: "POST",
		data : JSON.stringify(formData),
		beforeSend: function(xhr) {
			xhr.setRequestHeader("Accept", "application/json");
...
function updateGroup(){
	...
	var formData={"id":id,"name":name};
	$.ajax({
		url : "/manytomanyunidirectional/group/mock/edit",
		type: "POST",
		data : JSON.stringify(formData),
		beforeSend: function(xhr) {
			xhr.setRequestHeader("Accept", "application/json");
...
function loadObjects(){
	$.ajax({
		url : "/manytomanyunidirectional/user/mock/findAll",
		type: "GET",
		data : {},
		dataType: "json",
		success: function(data, textStatus, jqXHR)
	...
	$.ajax({
		url : "/manytomanyunidirectional/group/mock/findAll",
		type: "GET",
		data : {},
		dataType: "json",
		success: function(data, textStatus, jqXHR)
	...
	$.ajax({
		url : "/manytomanyunidirectional/usergroup/mock/findAll",
		type: "GET",
		data : {},
		dataType: "json",
		success: function(data, textStatus, jqXHR)
...
function deleteUserObject(userid){
	...
	delurl="/manytomanyunidirectional/user/mock/remove/"+userid;
	$.ajax({
		url : delurl,
		type: "POST",
		data : userForm,
...
function deleteGroupObject(groupid){
	...
	delurl="/manytomanyunidirectional/group/mock/remove/"+groupid;
	$.ajax({
		url : delurl,
		type: "POST",
		data : groupForm,
...
function deleteUserGroupObject(userid,groupid){
	var formData={"userDto":{"id":userid},"groupDto":{"id":groupid}};
	delurl="/manytomanyunidirectional/usergroup/mock/remove";
	$.ajax({
		url : delurl,
		type: "POST",
		data : JSON.stringify(formData),
...
function editUserObject(userid){
	editurl="/manytomanyunidirectional/user/mock/findById/"+userid;
	var userForm={id:userid};
	$.ajax({
		url : editurl,
		type: "GET",
...
function editGroupObject(groupid){
	editurl="/manytomanyunidirectional/group/mock/findById/"+groupid;
	var groupForm={id:groupid};
	$.ajax({
		url : editurl,
		type: "GET",
