...
function create(){
	...
	$.ajax({
		url : "/concretetableinheritance/create",
		type: "POST",
...
function update(){
	...
	$.ajax({
		url : "/concretetableinheritance/edit",
		type: "POST",
		data : JSON.stringify(formData),
		beforeSend: function(xhr) {
			xhr.setRequestHeader("Accept", "application/json");
...
function loadObjects(){
	$.ajax({
		url : "/concretetableinheritance/findAll",
		type: "GET",
		data : {},
		dataType: "json",
		success: function(data, textStatus, jqXHR)
...
function deleteObject(estateid){
	...
	var delurl="/concretetableinheritance/remove/"+estateid;
	$.ajax({
		url : delurl,
		type: "POST",
		data : estateForm,
...
function editObject(estateid){
	var editurl="/concretetableinheritance/findById/"+estateid;
	var estateForm={id:estateid};
	$.ajax({
		url : editurl,
		type: "GET",
