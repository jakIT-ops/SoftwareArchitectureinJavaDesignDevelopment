...
function isPresent(){
	...
	var authorname = $("#authorSelectBox").find('option:selected').text();
	...
	if(null != manuscriptid && "" != manuscriptid && null!= authorid && "" != authorid && null!= publisher && "" != publisher) {
		...
		$.ajax({
			url : "/manytomanybidirectionalwithjoinattribute/manuscriptauthor/mock/isPresent",
			type: "POST",
			...
			{
				if(!data) {
					createManuscriptAuthor(manuscriptid, authorid, publisher, manuscriptname, authorname);
				} else {
...
function createManuscriptAuthor(manuscriptid, authorid, publisher, manuscriptname, authorname){
	var formData={"manuscriptDto":{"id":manuscriptid, "name":manuscriptname},"authorDto":{"id":authorid, "name":authorname},"publisher":publisher};
	
	$.ajax({
		url : "/manytomanybidirectionalwithjoinattribute/manuscriptauthor/mock/create",
		type: "POST",
		data : JSON.stringify(formData),
		beforeSend: function(xhr) {
			xhr.setRequestHeader("Accept", "application/json");
...
function createManuscript(){
	...
	if(null != name && "" != name) {
		...
		$.ajax({
			url : "/manytomanybidirectionalwithjoinattribute/manuscript/mock/create",
			type: "POST",
			data : JSON.stringify(formData),
			beforeSend: function(xhr) {
				xhr.setRequestHeader("Accept", "application/json");
...
function createAuthor(){
	...
	if(null != name && "" != name) {
		var formData={"name":name};
		$.ajax({
			url : "/manytomanybidirectionalwithjoinattribute/author/mock/create",
			type: "POST",
			data : JSON.stringify(formData),
			beforeSend: function(xhr) {
				xhr.setRequestHeader("Accept", "application/json");
...
function updateManuscript(){
	...
	$.ajax({
		url : "/manytomanybidirectionalwithjoinattribute/manuscript/mock/edit",
		type: "POST",
		data : JSON.stringify(formData),
		beforeSend: function(xhr) {
			xhr.setRequestHeader("Accept", "application/json");
...
function updateAuthor(){
	...
	var formData={"id":id,"name":name};
	$.ajax({
		url : "/manytomanybidirectionalwithjoinattribute/author/mock/edit",
		type: "POST",
		data : JSON.stringify(formData),
		beforeSend: function(xhr) {
			xhr.setRequestHeader("Accept", "application/json");
...
function loadObjects(){
	$.ajax({
		url : "/manytomanybidirectionalwithjoinattribute/manuscript/mock/findAll",
		type: "GET",
		data : {},
		dataType: "json",
		success: function(data, textStatus, jqXHR)
	...
	$.ajax({
		url : "/manytomanybidirectionalwithjoinattribute/author/mock/findAll",
		type: "GET",
		data : {},
		dataType: "json",
		success: function(data, textStatus, jqXHR)
	...
	$.ajax({
		url : "/manytomanybidirectionalwithjoinattribute/manuscriptauthor/mock/findAll",
		type: "GET",
		data : {},
		dataType: "json",
		success: function(data, textStatus, jqXHR)
...
function deleteManuscriptObject(manuscriptid){
	...
	delurl="/manytomanybidirectionalwithjoinattribute/manuscript/mock/remove/"+manuscriptid;
	$.ajax({
		url : delurl,
		type: "POST",
		data : manuscriptForm,
...
function deleteAuthorObject(authorid){
	...
	delurl="/manytomanybidirectionalwithjoinattribute/author/mock/remove/"+authorid;
	$.ajax({
		url : delurl,
		type: "POST",
		data : authorForm,
...
function deleteManuscriptAuthorObject(manuscriptid,authorid){
	...
	delurl="/manytomanybidirectionalwithjoinattribute/manuscriptauthor/mock/remove";
	$.ajax({
		url : delurl,
		type: "POST",
		data : JSON.stringify(formData),
...
function editManuscriptObject(manuscriptid){
	editurl="/manytomanybidirectionalwithjoinattribute/manuscript/mock/findById/"+manuscriptid;
	var manuscriptForm={id:manuscriptid};
	$.ajax({
		url : editurl,
		type: "GET",
...
function editAuthorObject(authorid){
	editurl="/manytomanybidirectionalwithjoinattribute/author/mock/findById/"+authorid;
	var authorForm={id:authorid};
	$.ajax({
		url : editurl,
		type: "GET",
