...
function isPresent(){
	...
	if(null != manuscriptid && "" != manuscriptid && null!= authorid && "" != authorid && null!= publisher && "" != publisher) {
		...
		$.ajax({
			url : "/manytomanybidirectionalwithjoinattribute/manuscriptauthor/isPresent",
			type: "POST",
...
function createManuscriptAuthor(manuscriptid,authorid,publisher){
	...
	$.ajax({
		url : "/manytomanybidirectionalwithjoinattribute/manuscriptauthor/create",
		type: "POST",
		data : JSON.stringify(formData),
		beforeSend: function(xhr) {
			xhr.setRequestHeader("Accept", "application/json");
...
function createManuscript(){
	...
	if(null != name && "" != name) {
		...
		$.ajax({
			url : "/manytomanybidirectionalwithjoinattribute/manuscript/create",
			type: "POST",
			data : JSON.stringify(formData),
			beforeSend: function(xhr) {
				xhr.setRequestHeader("Accept", "application/json");
...
function createAuthor(){
	...
	if(null != name && "" != name) {
		var formData={"name":name};
		$.ajax({
			url : "/manytomanybidirectionalwithjoinattribute/author/create",
			type: "POST",
			data : JSON.stringify(formData),
			beforeSend: function(xhr) {
				xhr.setRequestHeader("Accept", "application/json");
...
function updateManuscript(){
	...
	$.ajax({
		url : "/manytomanybidirectionalwithjoinattribute/manuscript/edit",
		type: "POST",
		data : JSON.stringify(formData),
		beforeSend: function(xhr) {
			xhr.setRequestHeader("Accept", "application/json");
...
function updateAuthor(){
	...
	var formData={"id":id,"name":name};
	$.ajax({
		url : "/manytomanybidirectionalwithjoinattribute/author/edit",
		type: "POST",
		data : JSON.stringify(formData),
		beforeSend: function(xhr) {
			xhr.setRequestHeader("Accept", "application/json");
...
function loadObjects(){
	$.ajax({
		url : "/manytomanybidirectionalwithjoinattribute/manuscript/findAll",
		type: "GET",
		data : {},
		dataType: "json",
		success: function(data, textStatus, jqXHR)
	...
	$.ajax({
		url : "/manytomanybidirectionalwithjoinattribute/author/findAll",
		type: "GET",
		data : {},
		dataType: "json",
		success: function(data, textStatus, jqXHR)
	...
	$.ajax({
		url : "/manytomanybidirectionalwithjoinattribute/manuscriptauthor/findAll",
		type: "GET",
		data : {},
		dataType: "json",
		success: function(data, textStatus, jqXHR)
...
function deleteManuscriptObject(manuscriptid){
	...
	delurl="/manytomanybidirectionalwithjoinattribute/manuscript/remove/"+manuscriptid;
	$.ajax({
		url : delurl,
		type: "POST",
		data : manuscriptForm,
...
function deleteAuthorObject(authorid){
	...
	delurl="/manytomanybidirectionalwithjoinattribute/author/remove/"+authorid;
	$.ajax({
		url : delurl,
		type: "POST",
		data : authorForm,
...
function deleteManuscriptAuthorObject(manuscriptid,authorid){
	...
	delurl="/manytomanybidirectionalwithjoinattribute/manuscriptauthor/remove";
	$.ajax({
		url : delurl,
		type: "POST",
		data : JSON.stringify(formData),
...
function editManuscriptObject(manuscriptid){
	editurl="/manytomanybidirectionalwithjoinattribute/manuscript/findById/"+manuscriptid;
	var manuscriptForm={id:manuscriptid};
	$.ajax({
		url : editurl,
		type: "GET",
...
function editAuthorObject(authorid){
	editurl="/manytomanybidirectionalwithjoinattribute/author/findById/"+authorid;
	var authorForm={id:authorid};
	$.ajax({
		url : editurl,
		type: "GET",
